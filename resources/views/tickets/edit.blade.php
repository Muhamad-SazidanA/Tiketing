...
@section('content')
    <div class="max-w-2xl mx-auto">
        <h2 class="text-2xl font-semibold text-slate-700 mb-6">Edit Ticket</h2>
            ...
            <form action="{{ route('tickets.update', $ticket) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        id="title" type="text" name="title" value="{{ old('title', $ticket->title) }}" required>
                    @error('title')
                ...
                <div class="mb-5">
                    ...
                    <select
                        ...
                        <option value="in_progress"
                            {{ old('status', $ticket->status) === 'in_progress' ? 'selected' : '' }}>In Progress</option>
